...
set wildcharm=<C-Z>
nnoremap <F10> :b <C-Z>
imap <F6> <esc>:w<CR>:SelRefresh PageToOpen <CR>i
map <F6> :w<CR>:SelRefresh PageToOpen <CR>
...
if has("autocmd")
  ...
  augroup module
    ...
    autocmd BufRead,BufNewFile *.test set filetype=drupal
  augroup END
endif
